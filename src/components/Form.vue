<template>
	<div
		...
		<textarea ref="textarea" v-model="formData.body" class=" bg-white w-3/4 border height mb-6 p-3"
			rows="25"></textarea>
		<button class="p-2 flex items-center justify-center rounded-md bg-blue-500 text-white mb-6 appearance-none"
			@click.stop="clearFormData">清空</button>
		<button class="p-2 flex items-center justify-center rounded-md bg-blue-500 text-white mb-6 appearance-none"
			@click.stop="emitcopy">复制配置</button>
...
import { reactive, watch, ref, nextTick, onUnmounted } from "vue";
